...
Function faveNum() { return faveNum; }
// CODE HERE
...
var myName;
function (myName!="Hakeem Olajuwon"){
...
if(colorResponse="Green"){
  document.write("Green is okay.")
}else if(colorResponse="Red"){
  document.write("I heart red.")
}
}else 
document.write("What is your favorite color?")
